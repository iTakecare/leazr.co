  ...
  return (
    <div className="flex flex-col min-h-screen items-center gap-6 md:gap-10 py-4 md:py-10 relative">
      ...
      <header className="relative w-full max-w-[1331px] mx-auto z-10 px-5 md:px-[37px]">
        ...
        <div className="fixed-bottom sm:absolute bottom-[-120px] md:bottom-[-140px] left-0 right-0 sm:left-[37px] flex flex-col sm:flex-row items-center w-full sm:w-auto px-4 sm:px-0 pb-4 sm:pb-0 bg-white sm:bg-transparent">
