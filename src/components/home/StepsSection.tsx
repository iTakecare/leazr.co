...
const StepsSection = () => {
  return (
    <section className="py-10 bg-transparent relative">
      <div className="absolute top-10 left-0 right-0 mx-auto w-[90%] max-w-4xl h-24 bg-[#48b5c3]/15 blur-[60px] rounded-full"></div>
      
      <div className="text-center mb-6 relative">
        <h2 className="text-[44px] font-bold text-gray-900 mb-3">
          Passer au leasing de matériel informatique
        </h2>
        <div className="inline-block bg-[#48b5c3]/20 text-[#48b5c3] px-6 py-1 rounded-md text-3xl font-bold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10 items-stretch">
        <div className="bg-[#e1f5f7] rounded-3xl p-6 relative overflow-hidden h-full flex flex-col justify-center">
          ...
          <h3 className="text-[28px] font-bold text-gray-800 mb-3">
