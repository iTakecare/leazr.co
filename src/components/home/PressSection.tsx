        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col">
            <h2 className="text-[46px] font-bold text-gray-900 mb-8">
              La presse <span className="bg-[#48b5c34f] text-[#48b5c3] px-6 py-1 rounded-lg group-hover:bg-[#33638E] group-hover:text-white relative top-[-2px]">parle de nous</span>
            </h2>
