        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col relative z-10">
            ...
            <div className="relative group mt-4">
              <img src="/lovable-uploads/88f6cdf6-516c-4d4f-8a9f-d74894212c9b.png" alt="Vidéo iTakecare" className="w-full h-auto rounded-lg shadow-md" />
              <div className="absolute inset-0 flex items-center justify-center">
                <a href="https://www.youtube.com/watch?v=YOUTUBE_VIDEO_ID" target="_blank" rel="noopener noreferrer" className="relative">
          ...
          <div className="flex items-center justify-center h-full mt-8 md:mt-16 relative z-10">
            <div className="grid grid-cols-3 grid-rows-3 gap-6 w-full">
              {mediaLogos.map(logo => <div key={logo.id} className="flex items-center justify-center h-24 sm:h-28">
                  <a href={logo.url} target="_blank" rel="noopener noreferrer" className="transition-transform hover:scale-105">
                    <img src={logo.src} alt={logo.alt} className="max-h-full max-w-full object-contain w-auto h-16 sm:h-20" />
                  </a>
                </div>)}
            </div>
          </div>
