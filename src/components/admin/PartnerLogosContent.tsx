...
interface PartnerLogosContentProps {
  embedded?: boolean;
  onSaveSuccess?: () => void;
}

export function PartnerLogosContent({ embedded = false, onSaveSuccess }: PartnerLogosContentProps) {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      {!embedded && (
        <div className="mb-4">
          <h3 className="text-lg font-semibold">Logos partenaires</h3>
