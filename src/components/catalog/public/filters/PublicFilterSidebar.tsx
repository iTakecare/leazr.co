...
import { PublicFilterState } from "@/hooks/products/usePublicProductFilter";

interface PublicFilterSidebarProps {
  isOpen: boolean;
  onClose: () => void;
  filters: PublicFilterState;
  updateFilter: <K extends keyof PublicFilterState>(key: K, value: PublicFilterState[K]) => void;
  resetFilters: () => void;
...
const PublicFilterSidebar: React.FC<PublicFilterSidebarProps> = ({
  isOpen,
  onClose,
  filters,
  updateFilter,
  ...
  return (
    <>
      ...
      <div className="hidden lg:block w-80 flex-shrink-0">
        <div className="sticky top-6 bg-background border rounded-lg p-6 space-y-6 max-h-[calc(100vh-2rem)] overflow-y-auto">
...
export default PublicFilterSidebar;
