...
const InlinePublicCart: React.FC<InlinePublicCartProps> = ({ 
  onBackToCatalog,
  onRequestQuote
}) => {
    ...
    <div className="py-8">
      ...
      {items.length === 0 ? (
        <div className="bg-white p-8 rounded-lg shadow-sm text-center">
          ...
          <Button onClick={onBackToCatalog}>Voir le catalogue</Button>
        </div>
      ) : (
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden sticky top-4">
              <div className="p-6">
                ...
                <Button className="w-full mt-6" size="lg" onClick={onRequestQuote}>
...
export default InlinePublicCart;