...
const CatalogApiSettings = () => {
  ...
  const endpoints: Endpoint[] = [
    ...
    {
      method: 'POST',
      path: 'partners/{slug}/next-reference',
      description: 'Génère et réserve le prochain numéro de dossier séquentiel au format ITC-YYYY-OFF-XXXX. Appeler AVANT de soumettre une demande pour obtenir le numéro à inclure dans le champ reference_number.',
      example: '{ "reference_number": "ITC-2026-OFF-9976" }'
    },
    {
      method: 'POST',
