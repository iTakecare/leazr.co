  ...
  return (
    <>
      ...
      <div className="hidden lg:block w-64 flex-shrink-0 ml-6">
        <div className="sticky top-44 bg-card border rounded-xl shadow-soft p-6 space-y-6 max-h-[calc(100vh-14rem)] overflow-y-auto backdrop-blur-sm border-border/50">
