...
export const ADMIN_CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "La proposition apparaît sur les deux chemins de création : le formulaire complet et la fenêtre rapide « Nouveau client » depuis la liste des clients.",
    ],
  },
  {
    version: "1.7.1",
    ...
    items: [
      ...
      "Une séquence s'arrête d'elle-même dès que le prospect répond, ou quand l'affaire change d'étape ou se referme. Les envois ne partent qu'en heures ouvrées (8h-18h en semaine) — hors créneau, ils sont reportés, pas annulés.",
      "Les désinscriptions par canal sont respectées, et tout envoi automatique apparaît dans la timeline de l'affaire.",
    ],
  },
  {
    version: "1.6.6",
