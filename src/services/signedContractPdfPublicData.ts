...
export const buildSignedContractPdfDataFromRpc = async (rpcData: any): Promise<SignedContractPDFData> => {
  ...
  const pdfData: SignedContractPDFData = {
    ...
    client_address: client.billing_address || client.address || undefined,
    client_city: client.billing_city || client.city || undefined,
    client_postal_code: client.billing_postal_code || client.postal_code || undefined,
    client_country: client.billing_country || client.country || 'Belgique',
