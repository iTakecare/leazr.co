...
export interface CommissionLevel {
  ...
  is_default: boolean;
  calculation_mode: 'margin' | 'purchase_price' | 'monthly_payment' | 'one_monthly_rounded_up' | 'fixed_per_pc';
 ...
 */
export const createCommissionLevel = async (levelData: { name: string; type: 'partner' | 'ambassador'; is_default?: boolean; calculation_mode?: 'margin' | 'purchase_price' | 'monthly_payment' | 'one_monthly_rounded_up' | 'fixed_per_pc'; fixed_rate?: number }): Promise<CommissionLevel | null> => {
  try {
 ...
 */
export const updateCommissionLevel = async (id: string, levelData: { name: string; is_default?: boolean; calculation_mode?: 'margin' | 'purchase_price' | 'monthly_payment' | 'one_monthly_rounded_up' | 'fixed_per_pc'; fixed_rate?: number }): Promise<CommissionLevel | null> => {
  try {
