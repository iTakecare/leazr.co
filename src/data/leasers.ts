...
export const defaultLeasers = [
  {
    ...
    logo_url: null,
    ranges: [
      { id: "75e0d12a-6780-4e9e-a9e4-3c1f5a4f5c49", min: 500, max: 2500, coefficient: 3.64 },
      { id: "d82c5b3f-c230-4eea-a9a2-389d68f5290e", min: 2500.01, max: 5000, coefficient: 3.28 },
