...
// Cette version de SignOffer est publique et ne nécessite pas d'authentification
const PublicSignOffer = () => {
  ...
  useEffect(() => {
    if (debugInfo) {
      console.log("Debug info (public):", debugInfo);
    }
    
    if (offer) {
      console.log("Offer data loaded (public view):", {
        id: offer.id,
