...
-- Supprimer les politiques RLS publiques pour commission_levels
...
-- Supprimer les politiques RLS publiques pour commission_rates
...
-- Supprimer les anciennes politiques et créer une politique d'isolation stricte
