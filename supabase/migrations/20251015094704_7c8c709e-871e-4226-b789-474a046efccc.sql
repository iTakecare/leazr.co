-- Mettre à jour le template HTML pour utiliser client_full_address et ajouter la boucle sur les produits
...
-- Mettre à jour le template HTML pour ajouter la boucle sur les équipements
UPDATE html_templates
SET html_content = REPLACE(
  html_content,
  '<tbody>
