-- Migration d'optimisation RLS ciblée sur les tables existantes uniquement
-- Optimise les politiques RLS avec des sous-requêtes pour améliorer les performances

-- OFFERS - Table principale avec le plus de warnings
...
-- BLOG POSTS - Optimiser les politiques existantes
...
-- MODULES - Optimiser les politiques existantes
