...
-- Créer une fonction SECURITY DEFINER pour insérer les attributs d'équipement
...
-- Créer une fonction SECURITY DEFINER pour insérer les spécifications d'équipement
