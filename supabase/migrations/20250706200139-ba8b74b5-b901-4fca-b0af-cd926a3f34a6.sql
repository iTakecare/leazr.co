...
-- Insert default availability hours (Monday to Friday, 9AM to 6PM)
INSERT INTO public.chat_availability_hours (company_id, day_of_week, start_time, end_time)
SELECT DISTINCT company_id, generate_series(1, 5), '09:00'::TIME, '18:00'::TIME
