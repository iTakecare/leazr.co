...
-- Version corrigée - sans la colonne contact_info manquante
...
-- 2. CORRIGER LA FONCTION INITIALIZE_NEW_COMPANY POUR UTILISER LES BONNES COLONNES
...
AS $$
BEGIN
  -- Créer des leasers par défaut pour la nouvelle entreprise (sans contact_info)
