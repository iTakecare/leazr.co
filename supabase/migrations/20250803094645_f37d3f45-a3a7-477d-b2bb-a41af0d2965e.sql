-- Drop existing functions first to update their signatures
DROP FUNCTION IF EXISTS public.search_postal_codes(text, text, integer);
DROP FUNCTION IF EXISTS public.get_cities_by_postal_code(text, text);
