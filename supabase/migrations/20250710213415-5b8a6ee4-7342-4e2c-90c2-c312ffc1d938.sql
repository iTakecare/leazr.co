...
-- Vérifier et recréer des leasers pour iTakecare si nécessaire
...
-- Recréer quelques produits de test pour iTakecare
...
(
  ...
  2500.00,
  'c1ce66bb-3ad2-474d-b477-583baa7ff1c0',
  (SELECT id FROM categories WHERE name = 'laptop' AND company_id = 'c1ce66bb-3ad2-474d-b477-583baa7ff1c0' LIMIT 1),
  (SELECT id FROM brands WHERE name = 'Apple' AND company_id = 'c1ce66bb-3ad2-474d-b477-583baa7ff1c0' LIMIT 1),
  now()
),
(
  'Dell OptiPlex 7000',
  ...
  1200.00,
  'c1ce66bb-3ad2-474d-b477-583baa7ff1c0',
  (SELECT id FROM categories WHERE name = 'desktop' AND company_id = 'c1ce66bb-3ad2-474d-b477-583baa7ff1c0' LIMIT 1),
  (SELECT id FROM brands WHERE name = 'Dell' AND company_id = 'c1ce66bb-3ad2-474d-b477-583baa7ff1c0' LIMIT 1),
  now()
)
