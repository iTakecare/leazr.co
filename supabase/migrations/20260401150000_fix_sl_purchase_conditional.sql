-- Fix: sl_purchase dans la marge et les achats uniquement si une facture SL existe ce mois-là
-- Cela évite les marges négatives sur les mois sans CA self-leasing
...
BEGIN
  ...
  SELECT
    ...
    -- Achats : sl_purchase inclus UNIQUEMENT si une facture SL existe ce mois
