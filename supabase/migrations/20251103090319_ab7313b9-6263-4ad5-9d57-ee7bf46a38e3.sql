-- Phase 1.2: Création de la fonction atomique de rate limiting
-- Cette fonction garantit l'atomicité et évite les conditions de concurrence
...
-- Fonction atomique pour incrémenter le compteur de rate limit
