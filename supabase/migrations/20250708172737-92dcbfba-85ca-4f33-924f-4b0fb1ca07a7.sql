...
-- Résout le problème où les nouveaux clients voient les données d'iTakecare
...
-- 2. FONCTION DE NETTOYAGE POUR LES UTILISATEURS EXISTANTS SANS PROFIL
...
-- 3. AMÉLIORER LA FONCTION DE CRÉATION D'ENTREPRISE
...
-- 4. RENFORCER L'ISOLATION DES DONNÉES - POLITIQUES RLS ULTRA-STRICTES

-- 4.1 Produits - isolation stricte
...
-- 4.3 Company Customizations - isolation stricte
...
-- 4.4 Clients - renforcer l'isolation
