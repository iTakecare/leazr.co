-- Migration to merge Winfinance duplicate clients (Fixed version)
...
-- Step 7: Transfer any partner_clients relationships
UPDATE public.partner_clients 
SET client_id = '48eba76a-7e2b-4301-8193-52746839de23'
WHERE client_id IN ('95a70859-c14e-4309-aed0-b470da22aed5', 'b3ea55d1-bdf4-46c6-a10d-f7ddab03c62a');

-- Step 8: Transfer any client delivery sites
UPDATE public.client_delivery_sites 
SET client_id = '48eba76a-7e2b-4301-8193-52746839de23'
WHERE client_id IN ('95a70859-c14e-4309-aed0-b470da22aed5', 'b3ea55d1-bdf4-46c6-a10d-f7ddab03c62a');

-- Step 9: Transfer any custom pricing data
...
-- Step 10: Handle duplicate collaborators - remove exact duplicates
...
-- Step 11: Set the oldest collaborator as primary
UPDATE public.collaborators 
SET is_primary = true 
WHERE id = (
  SELECT id 
...
-- Step 12: Finally, delete the duplicate clients
