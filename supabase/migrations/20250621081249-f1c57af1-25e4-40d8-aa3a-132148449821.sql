...
-- Mettre à jour la fonction create_client_as_ambassador pour inclure le company_id
...
BEGIN
  ...
  VALUES (
    ...
    client_data->>'country',
    ambassador_company_id,  -- Utiliser le company_id de l'ambassadeur
    COALESCE((client_data->>'is_ambassador_client')::boolean, true)
  )
