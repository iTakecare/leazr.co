...
-- Migration : Ajout du statut 'extended' dans get_monthly_financial_data
--
-- Problème : Les contrats avec status='extended' (ex: Dav Constructance ITC-2023-005)
-- n'étaient pas comptabilisés dans les achats du dashboard financier.
-- La fonction filtrait uniquement : 'signed', 'active', 'delivered', 'completed', 'equipment_ordered'
--
-- Fix : Ajout de 'extended' dans les deux filtres de statut.
