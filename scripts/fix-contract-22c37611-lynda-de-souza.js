/**
 * fix-contract-22c37611-lynda-de-souza.js
 *
 * Contrat: 22c37611 - Lynda De Souza (2024, Grenke)
 * Action : Supprime la ligne groupée [ab530fac] et crée 4 lignes séparées.
 *
 * PA DB  : 2592.00€ (incorrect)
 * PA SS  : 2429.00€ (spreadsheet — correct)
 *
 * Usage:
 *   node scripts/fix-contract-22c37611-lynda-de-souza.js          # dry-run
 *   node scripts/fix-contract-22c37611-lynda-de-souza.js --apply
 */
...
const CONTRACT_ID_PREFIX = '22c37611';
const GROUPED_ID_PREFIX  = 'ab530fac';

const NEW_EQUIPMENT = [
  { title: 'HP ProBook 450 G9 15.6 pouces 16Go 1To | SN: 5CD333HDMN',          quantity: 1, purchase_price: 558.00 },
  { title: 'Microsoft Surface 8 Pro - 8Go - 256Go Wifi - Win 11 | SN: 0F00V59214901J', quantity: 1, purchase_price: 694.00 },
  { title: 'Epson EcoTank ET-5800 | SN: X7HC017383',                            quantity: 1, purchase_price: 562.00 },
  { title: 'Apple iPhone 13 Pro Max - 128Go RFB GR A | SN: JG4W5CFX0M',        quantity: 1, purchase_price: 615.00 },
];
