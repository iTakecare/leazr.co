/**
 * fix-contract-3f368667-esteban-arriaga.js
 * Fix contract equipment for Esteban Arriaga
 * Replaces grouped line with MacBook Air M2 and Logitech keyboards/mice
 */
...
const CONTRACT_ID_PREFIX = '3f368667';
const GROUPED_ID_PREFIX = '34e74ef3';

const NEW_EQUIPMENT = [
  { title: 'MacBook Air M2 15 8/256 QWERTY | SN: QG1H402RC9', quantity: 1, purchase_price: 1155.00 },
  { title: 'Clavier Logitech MX Keys sans fils (QWERTY)', quantity: 4, purchase_price: 83.32 },
  { title: 'Clavier Logitech Wave Keys sans fils (QWERTY)', quantity: 1, purchase_price: 66.66 },
  { title: 'Souris Logitech MX', quantity: 1, purchase_price: 55.00 }
];
