/**
 * fix-contract-0f586f25-xavier-gorskis-imprimante.js
 * Fix contract equipment for Xavier Gorskis (Imprimante)
 * Replaces grouped line with network equipment and Brother printers
 */
...
const CONTRACT_ID_PREFIX = '0f586f25';
const GROUPED_ID_PREFIX = '471ce104';

const NEW_EQUIPMENT = [
  { title: 'Switch 48 ports', quantity: 3, purchase_price: 319.54 },
  { title: 'Petit matériel (switch HDMI / câble HDMI / adaptateurs)', quantity: 1, purchase_price: 227.20 },
  { title: 'Cables RJ45', quantity: 1, purchase_price: 311.50 },
  { title: 'Brother DCP-L8410CDW color laser 31ppm', quantity: 3, purchase_price: 343.80 },
  { title: 'Good Connections® ANTARES T65 + FP', quantity: 2, purchase_price: 1273.50 }
];
...
console.log('\n🔧 FIX - Xavier Gorskis / Imprimante (0f586f25)');
