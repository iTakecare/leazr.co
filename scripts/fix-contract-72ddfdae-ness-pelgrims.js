/**
 * fix-contract-72ddfdae-ness-pelgrims.js
 * Fix contract equipment for Ness Pelgrims
 * Replaces grouped line with iPad Pro and iPhone 15 Pro Max
 */
...
const CONTRACT_ID_PREFIX = '72ddfdae';
const GROUPED_ID_PREFIX = '51922cef';

const NEW_EQUIPMENT = [
  { title: 'iPad Pro 11 pouces 2020 - 256 Go, Wifi + 4G | SN: DMPDG0CXNTH8', quantity: 1, purchase_price: 612.50 },
  { title: 'Apple iPhone 15 Pro Max - 256 Go, Neuf - MAUVE | SN: 357926955197459', quantity: 1, purchase_price: 1112.32 }
];
