/**
 * fix-contract-1d3d5686-marine-georges.js
 * Fix contract equipment for Marine Georges
 * Replaces grouped line with HP EliteBook + Samsung display
 */
...
const CONTRACT_ID_PREFIX = '1d3d5686';
const GROUPED_ID_PREFIX = 'c23dc410';

const NEW_EQUIPMENT = [
  { title: 'HP ELITEBOOK 650 G9 15.6" FHD I5-1245U 16GB 512GB SSD NVME WIN11 PRO | SN: 5Y3U5EAX3E', quantity: 1, purchase_price: 577.69 },
  { title: 'Ecran Samsung 24" incurvé', quantity: 1, purchase_price: 78.43 }
];
