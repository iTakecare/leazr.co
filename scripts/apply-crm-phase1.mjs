 ...
 *
 * Le DDL et le backfill borné (une opportunité par offre) passent en une
 * requête. La projection de l'historique, elle, est découpée en lots : sur un
 * volume réel d'emails et de messages elle dépasse le statement_timeout.
 *
...
// ─── 2) Projection de l'historique, par lots ─────────────────────────────────
//
