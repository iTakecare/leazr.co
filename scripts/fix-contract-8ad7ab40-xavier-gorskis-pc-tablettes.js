/**
 * fix-contract-8ad7ab40-xavier-gorskis-pc-tablettes.js
 * Fix contract equipment for Xavier Gorskis (PC & Tablettes)
 * Replaces grouped line with HP EliteDesks, displays, and Surface tablets
 */
...
const CONTRACT_ID_PREFIX = '8ad7ab40';
const GROUPED_ID_PREFIX = '0dc90fed';

const NEW_EQUIPMENT = [
  { title: 'HP EliteDesk 800 G6 mini i5/16Go/256Go SSD + clavier + souris', quantity: 28, purchase_price: 339.65 },
  { title: 'Ecran Samsung S24C360EAU (Kosatec)', quantity: 28, purchase_price: 87.00 },
  { title: 'Ecran Samsung S24C360EAU (Kosatec) - lot 2', quantity: 18, purchase_price: 82.50 },
  { title: 'Ecran AOC 24B2XHM2', quantity: 10, purchase_price: 74.38 },
  { title: 'Tablettes Surface Go 2', quantity: 4, purchase_price: 188.00 }
];
...
console.log('\n🔧 FIX - Xavier Gorskis / PC & Tablettes (8ad7ab40)');
